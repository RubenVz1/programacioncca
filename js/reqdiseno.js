...
$('#masImagenes').click(function() {
    $('#imagenes').append("<p id='p" + indice1 + "'>Fotografia en alta resolucion: </p><input class='mb-4' id='photo" + indice1 + "' type='file' accept='image/x-png,image/gif,image/jpeg' name='foto" + indice1 + "'><br id='s" + indice1 + "'>");
    indice1++;
...
$('#masLogos').click(function() {
    $('#logos').append("<p id='q" + indice2 + "'>Logo en alta resolucion: </p><input class='mb-4' id='logo" + indice2 + "' type='file' accept='image/x-png,image/gif,image/jpeg' name='logo" + indice2 + "'><br id='r" + indice2 + "'>");
    indice2++;
